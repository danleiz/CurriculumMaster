...
import edu.cmu.master.control.SemesterLoader;
 ...
 * interface.
 */
public class SemesterListFragment extends ListFragment implements LoaderManager.LoaderCallbacks<String[]> {
	...
	/* The adapter represents the array of department names */
	...
	public Loader<String[]> onCreateLoader(int id, Bundle args) {
		...
		Student current = ((MasterApplication)ctex.getApplicationContext()).getCurrentStudent();
		
		SemesterLoader loader = new SemesterLoader(ctex, current.getStudentEmail());
		return loader;
	}

	@Override
	public void onLoadFinished(Loader<String[]> loader, String[] semesters) {
		mAdapter.clear();
		mAdapter.addAll(semesters);
		if(isResumed()) {
			setListShown(true);
		} else {
