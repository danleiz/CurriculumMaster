...
import edu.cmu.master.control.DepartmentLoader;

public class DepartmentListFragment extends ListFragment implements LoaderManager.LoaderCallbacks<String[]> {
	/**
	...
	public Loader<String[]> onCreateLoader(int id, Bundle args) {
		...
		DepartmentLoader loader = new DepartmentLoader(ctex);
		return loader;
	}

	@Override
	public void onLoadFinished(Loader<String[]> loader, String[] departmentNames) {
		mAdapter.clear();
		mAdapter.addAll(departmentNames);
		if(isResumed()) {
			setListShown(true);
		} else {
